  ...
  return (
    <div className="relative bg-brand-primary overflow-hidden min-h-[85vh] flex items-center pt-16">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Modern Gradient Overlay: Clearer at top, darker at bottom/left for text */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-brand-surface/90 font-light leading-relaxed mb-10 max-w-2xl">
            We empower multicultural communities to lead the transition to a sustainable future, bridging the gap between local grassroots action and national policy.
          </p>
